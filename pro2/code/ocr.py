...
classifiers = {"kNN": neighbors.KNeighborsClassifier(), "NB": naive_bayes.GaussianNB(), "DT": tree.DecisionTreeClassifier(max_depth = 10), "RF": ensemble.RandomForestClassifier(max_depth = 20, n_estimators = 50), "SVM": svm.SVC(gamma = 0.001), "MLP": neural_network.MLPClassifier(), "SGD": linear_model.SGDClassifier(loss = 'hinge')}
